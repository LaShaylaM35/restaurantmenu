...
export const ChatBotForm = () => {
  ...
  const  [menu_items , setMenu] = useState("");
    ...
    const instructions = `
    You are going be a helpfull assintant in my online restaurant. You are going to help customers to make an order.
    
    The menu items are as follow:

    ${menu_items}

    You are going to take the order for the selected menu items and the request to our staff. 

    Always confirm the order

    When the order is confirmed say Thank You For Ordering with Us, have a nice day, and give a summary of the grand total!
